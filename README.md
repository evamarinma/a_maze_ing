...
```
<button onclick="navigator.clipboard.writeText('clone git@vogsphere-v2.42madrid.com:vogsphere/intra-uuid-7f0a7342-6639-416d-80ed-3eb0d475c353-7269739-mabada-r')">Copy</button>
<br>
